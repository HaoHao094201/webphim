    ...
    <div class="left">
        ...
        <div class="ptright">
            ...
            <div class="btnr">
                ...
                <p>Tên diễn viên:
                    <a style="text-decoration:none; color:white;" href="chitietdienvien.php?ID=<?=$row_dv['ID_DienVien']?>"><?=$row_dv['TenDienVien'];?></a>,
                    <a style="text-decoration:none; color:white;" href="chitietdienvien2.php?ID=<?=$row_dv2['ID_DienVien2']?>"><?=$row_dv2['TenDienVien2']?></a>
                </p>
