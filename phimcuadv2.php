<?php
    ...
    if (isset($_GET['ID'])) 
    {
        ...
        join dienvien2 on phim.DienVien2 = dienvien2.ID_DienVien2 WHERE DienVien2=$id limit ".$item_per_page." offset ".$offset."";
        $phim = mysqli_query($conn, $sql);  
        $phimm =  mysqli_query($conn, "SELECT * FROM phim WHERE DienVien2=$id" );
    ...
    $dv2 = mysqli_query($conn, $sql);
    $tendv2 = mysqli_fetch_assoc($dv2);  
?>

<div class="than">
    <div class="left">
        <div class="menu">
            <div class="l"><b style="font-size: 30px; color: #f3ff50fd;">Phim của <?=$tendv2['TenDienVien2']?></b></div>
        </div>
        <div class="anhĐC">
            <?php
