<?php
    ...
    if (isset($_GET['ID'])) 
    {
        ...
        $id = $_GET['ID'];
        $sql = "SELECT * FROM phim join phimle on phim.PhimLe = phimle.ID_PhimLe WHERE PhimLe=$id limit ".$item_per_page." offset ".$offset."";
        $phim = mysqli_query($conn, $sql); 
        $phimm =  mysqli_query($conn, "SELECT * FROM phim WHERE PhimLe=$id" );
    ...
    $sql = "SELECT * FROM phimle WHERE ID_PhimLe = $id";
    $pl = mysqli_query($conn, $sql);
    $tenpl = mysqli_fetch_assoc($pl);
...
<div class="than">
    <div class="left">
        <div class="menu">
            <div class="l"><b style="font-size: 30px; color: #f3ff50fd;"><?=$tenpl['TenPhimLe']?></b></div>
        </div>
        <div class="anhĐC">
            <?php
            ...
            ?>
                <div class="mot">
                    ...
                    <div class="product"><a><?php echo $row['TenPhimLe'];?></a></div>
