<?php
    ...
    if (isset($_GET['timkiem']))
    {
        ...
        $sql = "SELECT * FROM phim join theloai on phim.TheLoai = theloai.ID_TheLoai WHERE TenPhim like '%$timkiem%' limit ".$item_per_page." offset ".$offset."";
        $phim = mysqli_query($conn, $sql);
        $phimm =  mysqli_query($conn, "SELECT * FROM phim WHERE TenPhim like '%$timkiem%'" );
...
<div class="than">
    <div class="left">
        <div class="menu">
            <div class="l"><b style="font-size: 30px; color: #f3ff50fd;">Kết quả '<?=$timkiem?>'</b></div>
        </div>
        <div class="anhĐC">
            <?php
            ...
            ?>
                <div class="mot">
                    ...
                    <div class="product"><a href="theloai_phim.php?ID=<?=$row['ID_TheLoai']?>"><?=$row['TenTheLoai']?></a></div>
