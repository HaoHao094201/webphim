<?php
    ...
    $sql = "SELECT * FROM phim join theloai on phim.TheLoai = theloai.ID_TheLoai order by phim.ID limit ".$item_per_page." offset ".$offset."";
    $phim = mysqli_query($conn, $sql);
    $phimm =  mysqli_query($conn, "SELECT * FROM phim " );
...
<div class="than">
    <div class="left">
        <div class="menu">
            <div class="l"><b style="font-size: 30px; color: #f3ff50fd;">Phim đề cử</b></div>
        </div>
        <div class="anhĐC">
            <?php
