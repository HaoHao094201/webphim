<?php
    ...
    if (isset($_GET['ID'])) 
    {
        ...
        $id = $_GET['ID'];
        $sql = "SELECT * FROM phim join quocgia on phim.QuocGia = quocgia.ID_QuocGia WHERE QuocGia=$id limit ".$item_per_page." offset ".$offset."";
        $phim = mysqli_query($conn, $sql);  
        $phimm =  mysqli_query($conn, "SELECT * FROM phim WHERE QuocGia=$id" );
    ...
    $sql = "SELECT * FROM quocgia WHERE ID_QuocGia = $id";
    $qg = mysqli_query($conn, $sql);
    $tenqg = mysqli_fetch_assoc($qg);
...
<div class="than">
    <div class="left">
        <div class="menu">
            <div class="l"><b style="font-size: 30px; color: #f3ff50fd;">Phim <?=$tenqg['TenQuocGia']?></b></div>
        </div>
        <div class="anhĐC">
            <?php
            ...
            ?>
                <div class="mot">
                    ...
                    <div class="product"><a><?php echo $row['TenQuocGia'];?></a></div>
