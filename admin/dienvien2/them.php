<?php
    ...
    if(isset($_POST['sbm']))
    {
        ...
        $sql = "INSERT INTO dienvien2 (TenDienVien2, Anh_DV2, NgaySinh, NoiSinh, QuocTich, ChieuCao, CanNang, NgheNghiep, HoatDong, MoTa)
        VALUES ('$TenDienVien2', '$Anh_DV2', '$NgaySinh', '$NoiSinh', '$QuocTich', '$ChieuCao', '$CanNang', '$NgheNghiep', '$HoatDong', '$MoTa')";
...
<div class="container-fluid">
    <div class="card">
        <div class="card-header">
            <h2>Thêm diễn viên 2</h2>
        </div>
        <div class="card-body">
            <form method="POST" action="" enctype="multipart/form-data">
            <div class="form-group">
                    <label for="">Tên diễn viên</label>
                    <input type="text" name="TenDienVien2" class="form-control" required>
                </div>
                <div class="form-group">
